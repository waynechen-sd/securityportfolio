...
![API Security, WAF, and API Gateway scope comparison](../assets/images/supporting/api-security-scope.png)

![De-identified API governance priorities](../assets/images/supporting/api-governance-priorities.png)
...
![De-identified vendor-documentation boundary](../assets/images/supporting/vendor-documentation-boundary.png)
